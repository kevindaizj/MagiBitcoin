...
DROP TABLE BASE_TRANSACTION;
CREATE TABLE BASE_TRANSACTION(
ID VARCHAR(50) PRIMARY KEY, 
TRANSACTION_ID NVARCHAR(200) NOT NULL,
TRANSACTION_TYPE INT NOT NULL,  -- 1: BTC   2:USDT
FROM_ADDRESS VARCHAR(100) NOT NULL,
TO_ADDRESS VARCHAR(100) NOT NULL,
CHANGE_ADDRESS VARCHAR(100) NOT NULL,
FEE_ADDRESS VARCHAR(100) NULL,
FEE_RATE DECIMAL NOT NULL,  -- Sat/Bytes
ESTIMATE_SIZE INT NOT NULL,
